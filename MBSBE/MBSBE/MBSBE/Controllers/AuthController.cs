    ...
    public class AuthController : ControllerBase
    {
       ...
       // [Authorize(Roles = "ADMIN")]
        ...
        public async Task<IActionResult> AddUser([FromBody] User userObj)
        {
            ...
            //if (userObj.UserType == UserType.Customer)
            //{
            //    userObj.KW_Allowed = userObj.KW_Allowed; // Ensure your User model has this property
            //    userObj.BasePrice = userObj.BasePrice;
            //}
            //userObj.Token = "";
